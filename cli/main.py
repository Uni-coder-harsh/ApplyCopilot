...
from cli.commands import init, sync, jobs, resume, followups, skills
...
app.add_typer(skills.app,    name="skills",    help="Scan projects and manage skills")
...
def main(ctx: typer.Context):
    ...
    if ctx.invoked_subcommand is None:
        console.print(
            "\n[bold cyan]ApplyCopilot[/bold cyan] v0.1.0\n"
